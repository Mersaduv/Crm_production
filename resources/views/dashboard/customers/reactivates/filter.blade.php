    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link filter-area-suspend mr-2 {{ request('attr') == 'pendings' ? 'active' : '' }}"
                type="button" role="tab" attr="pendings">Suspend Requests</button>
            <button
                class="nav-link filter-area-reactivate mr-2 {{ request('attr') == 'reactivations' ? 'active' : '' }}"
                type="button" role="tab" attr="reactivations">Reactivation Requests</button>
        </div>
    </nav>
</div> <!-- /card-header -->
<div class="card-body">
                    ...
                    <div class="action_dropdown_area">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                @can('view', $customer)
                                <a class="dropdown-item" href="{{ route('admin.reactivates.show', $customer->id) }}">
