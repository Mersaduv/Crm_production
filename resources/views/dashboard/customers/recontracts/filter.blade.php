    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link filter-area-terminate  mr-2 {{ request('attr') == 'pending' ? 'active' : '' }}"
                type="button" role="tab" attr="pending">Termination Requests</button>
            <button class="nav-link filter-area-recontract  mr-2 {{ request('attr') == 'recontract' ? 'active' : '' }}"
                type="button" role="tab" attr="recontract">Recontraction Requests</button>
        </div>
    </nav>
</div> <!-- /card-header -->
<div class="card-body">
                    ...
                    <div class="action_dropdown_area">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                @can('view', $customer)
                                <a class="dropdown-item" href="{{ route('admin.recontract.show', $customer->id) }}">
