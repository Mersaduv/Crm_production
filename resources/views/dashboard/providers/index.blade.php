            ...
            <div class="history">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 historyBTN">
                        @can('create',ProviderFullyQualifiedNameSpace())

                        <button class="btn btn-primary btn-sm">
                            <a href="{{ route('providers.create') }}" class="btn btn-ctr">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                                Add New
                            </a>
                        </button>
                        @endcan
                        @canany(['restore'], ProviderFullyQualifiedNameSpace())
                        <button class="btn btn-danger btn-sm">
                            <a href="{{ route('providers.trashed') }}" class="btn btn-ctr">
                    ...
                    <table class="table" id="my-table">
                        <thead>
                            <tr>
                                ...
                                <th>Name</th>
                                <th>User</th>
                                @canany(['update', 'view', 'delete'], ProviderFullyQualifiedNameSpace())
                                <th>Operation</th>
                                @endcanany
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                @canany(['update', 'view', 'delete'], $provider)
                                <td class="">
