...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Package Reports</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('reports.package') }}
                    </div>
        ...
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse {{ $isFilter == 'true' ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('reports.package') }}">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="package" id="package"
                                                            ...
                                                            value="{{ request('package') ? request('package') : ''  }}" />
                                                        <ul id="packages_list"></ul>
                                                        <input type="hidden" name="package_id" id="package_id"
                                                            value="{{ request('package_id') ? request('package_id') : ''  }}" />
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('export-packages')}}" class="btn btn-primary" target="__blank">
                        Export All To CSV
                    </a>
                    <button class="btn btn-primary"
                        onclick="$('#my-table').table2csv({ filename: 'packages-report.csv' });">
                        Export To CSV
                    </button>
                </div>
                <div class="card-body">
                    <table class="table text-center" id="my-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>{{ status($customer->customer_id)['status'] }}</th>
                                <th>{{ status($customer->customer_id)['date'] }}</th>
                            </tr>
                            <?php $index ++ ?>
                            @endforeach
                        </tbody>
