    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('reports.base') }}
                    </div>
        ...
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse {{ $isFilter == 'true' ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('reports.base') }}">
                                            @csrf
                                            <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header">
                        <a href="{{ route('export-bases')}}" class="btn btn-primary" target="__blank">
                            Export All To CSV
                        </a>
                        <button class="btn btn-primary"
                            onclick="$('#my-table').table2csv({ filename: 'branchs-report.csv' });">
                            Export To CSV
                        </button>
                    </div>
                    <div class="card-body">
