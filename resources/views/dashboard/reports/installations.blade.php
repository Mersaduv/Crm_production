    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('reports.installation') }}
                    </div>
        ...
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse {{ $isFilter == 'true' ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('reports.installation') }}">
                                            @csrf
                                            <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('export-total-customers')}}" class="btn btn-primary" target="__blank">
                        Export All To CSV
                    </a>
                    <button class="btn btn-primary"
                        onclick="$('#my-table').table2csv({ filename: 'total-customers-report.csv' });">
                        Export To CSV
                    </button>
                </div>
                <div class="card-body">
                    <table class="table text-center" id="my-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    {{ status($customer->customer_id)['status'] }}
                                </th>
                                <th>
                                    {{ status($customer->customer_id)['date'] }}
                                </th>
                            </tr>
                            <?php $index ++ ?>
                            @endforeach
