    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('reports.recontract') }}
                    </div>
        ...
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse {{ $isFilter == 'true' ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('reports.recontract') }}">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="recontract">
                                                            Recontaction Date:
                                                        </label>
                                                        <input type="date" name="recontract" id="recontract"
                                                            value="{{ request('recontract') ? request('recontract') : '' }}"
                                                            class="form-control" />
                                                    </div>
                                                </div> <!-- /col -->
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="recontractStart">
                                                            Recontraction Date:
                                                        </label>
                                                        <input type="date" name="recontractStart" id="recontractStart"
                                                            value="{{ request('recontractStart') ? request('recontractStart') : '' }}"
                                                            class="form-control" />
                                                    </div>
                                                </div> <!-- /col -->
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="recontractEnd">End Date:</label>
                                                        <input type="date" name="recontractEnd" id="recontractEnd"
                                                            value="{{ request('recontractEnd') ? request('recontractEnd') : '' }}"
                                                            class="form-control" />
                                                    </div>
                                                </div> <!-- /col -->
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('export-recontracts')}}" class="btn btn-primary" target="__blank">
                        Export All To CSV
                    </a>
                    <button class="btn btn-primary"
                        onclick="$('#my-table').table2csv({ filename: 'recontracts-report.csv' });">
                        Export To CSV
                    </button>
                </div>
                <div class="card-body">
                    <table class="table text-center" id="my-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>{{ $customer->terminate->termination_date }}</th>
