    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('reports.customers') }}
                    </div>
        ...
        <div class="page-content-box">
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('export-active-customers')}}" class="btn btn-primary" target="__blank">
                        Export All To CSV
                    </a>
                    <button class="btn btn-primary"
                        onclick="$('#my-table').table2csv({ filename: 'active-customers-report.csv' });">
                        Export To CSV
                    </button>
