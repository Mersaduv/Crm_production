...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Device Type Reports</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('reports.device') }}
                    </div>
        ...
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse {{ $isFilter == 'true' ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('reports.device') }}">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="receiver_type" id="receiver_type"
                                                            class="form-control" placeholder="Receiver Type:"
                                                            autocomplete="off"
                                                            value="{{ request('receiver_type') ? request('receiver_type') : '' }}" />
                                                        <ul id="receiver_type_list"></ul>
                                                        <input type="hidden" name="receiver_type_id"
                                                            id="receiver_type_id" value="" />
                                                    </div>
                                                </div> <!-- /col -->
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="router_type" id="router_type"
                                                            class="form-control" autocomplete="off"
                                                            placeholder="Router Type:"
                                                            value="{{ request('router_type') ? request('router_type') : '' }}" />
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('export-devices')}}" class="btn btn-primary" target="__blank">
                        Export To CSV
                    </a>
                    <button class="btn btn-primary"
                        onclick="$('#my-table').table2csv({ filename: 'devices-report.csv' });">
                        Export To CSV
                    </button>
                </div>
                <div class="card-body">
                    <table class="table text-center" id="my-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    {{ $customer->sale->router_type ? $customer->sale->router_type : 'NA' }}
                                </th>
                            </tr>
                            <?php $index ++ ?>
                            @endforeach
