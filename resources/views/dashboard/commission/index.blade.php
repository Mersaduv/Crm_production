    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('resellers') }}
                    </div>
                    <div class="col-sm-6 historyBTN">
                        @can('create',CommissionFullyQualifiedNameSpace())

                        <button class="btn btn-primary btn-sm">
                            <a href="{{ route('commission.create') }}" class="btn btn-ctr">
                                <i class="fa fa-plus" aria-hidden="true"></i>
                                Add New
                            </a>
                        </button>
                        @endcan
                        @canany(['restore'], CommissionFullyQualifiedNameSpace())
                        <button class="btn btn-danger btn-sm">
                            <a href="{{ route('commissions.trashed') }}" class="btn btn-ctr">
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('commission.index') }}">
                                            @csrf
                                            <div class="row">
                    ...
                    <table class="table" id="my-table">
                        <thead>
                            <tr>
                                ...
                                <th>Phone</th>
                                <th>User</th>
                                @canany(['update', 'view', 'delete'], CommissionFullyQualifiedNameSpace())
                                <th>Operation</th>
                                @endcanany
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                @canany(['update', 'view', 'delete'], $commission)
                                <td class="">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('commission.edit',$commission->id) }}">
