...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Edit Reseller</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('resellers.edit',$commission) }}
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control"
                                        value="{{ $commission->name }}" autocomplete="off" required />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control"
                                        value="{{ $commission->phone }}" autocomplete="off" required />
                                </div>
                            </div>
                        </div> <!-- /row -->
