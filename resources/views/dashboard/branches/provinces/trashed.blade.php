    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('province.trashed') }}
                    </div>
                    ...
                    <table class="table" id="my-table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
                                @canany(['restore'], ProvinceFullyQualifiedNameSpace())
                                <th>Operation</th>
                                @endcanany
                            </tr>
                        </thead>
                                    ...
                                    <div class="action_dropdown_area">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                @can('restore',$province)
                                                <form method="post"
                                                    action="{{ route('province.restore',$province->id) }}">
                                                    @csrf
                                                    @method('put')
