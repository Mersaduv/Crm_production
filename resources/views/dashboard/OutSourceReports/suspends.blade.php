...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Suspends Reports</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('outsource.reports.suspends') }}
                    </div>
        ...
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse {{ $isFilter == 'true' ? 'show' : '' }}"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('outsource.reports.suspends') }}">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="suspend" id="suspend"
                                                            value="{{ request('suspend') ? request('suspend') : '' }}"
                                                            class="form-control" />
                                                    </div>
                                                </div> <!-- /col -->
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="suspendStart" id="suspendStart"
                                                            value="{{ request('suspendStart') ? request('suspendStart') : '' }}"
                                                            class="form-control" />
                                                    </div>
                                                </div> <!-- /col -->
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" name="suspendEnd" id="suspendEnd"
                                                            value="{{ request('suspendEnd') ? request('suspendEnd') : '' }}"
                                                            class="form-control" />
                                                    </div>
                                                </div> <!-- /col -->
            ...
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('provincial.export-suspends')}}" class="btn btn-primary" target="__blank">
                        Export All To CSV
                    </a>
                    <button class="btn btn-primary"
                        onclick="$('#my-table').table2csv({ filename: 'provincial-suspends-report.csv' });"> Export To
                        CSV
                    </button>
                </div>
                <div class="card-body">
