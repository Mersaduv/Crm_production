    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('manager.pr.suspend',$customer->provincial) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                                ...
                                <div class="media-29101 d-md-flex w-100">
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Reseller Name</th>
                                                <td>{{ $customer->suspend->commission ?
                                                    $customer->suspend->commission->name : 'NA' }}</td>
                                            </tr>
                                            <tr>
                ...
                <div class="col-md-3">
                    @include('dashboard.provincial.reactivates.sidebar')
                </div> <!-- /col-3 -->
