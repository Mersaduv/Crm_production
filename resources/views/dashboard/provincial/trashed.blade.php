    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('manager.pr.trash') }}
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('admin.pr.tr') }}">
                                            @csrf
                                            <div class="row">
                    ...
                    <table class="table" id="my-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    {{ Carbon\Carbon::parse($customer->deleted_at)->format('Y-m-d') }}
                                </th>
                                <th class="operation">
                                    <a href="{{ route('admin.pr.show',$customer->id) }}">
