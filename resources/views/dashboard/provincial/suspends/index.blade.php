...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Suspend Customers</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('manager.pr.suspends') }}
                    </div>
                </div> <!-- /row -->
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('admin.pr.suspends') }}">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="suspendDate">
                                                            Suspend Date:
                                                        </label>
                                                        <input type="date" name="suspendDate" id="suspendDate"
                                                            class="form-control" />
                                                    </div>
                                                </div> <!-- /col -->
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="endSusDate">End Date:</label>
                                                        <input type="date" name="endSusDate" id="endSusDate"
                                                            class="form-control" />
                                                    </div>
                                                </div> <!-- /col -->
            ...
            <div class="card" id="filter-area-pr-suspend">
                <div class="card-header">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link filter-area-pr-suspend mr-2 active" type="button" role="tab"
                                attr="suspend">Suspends</button>
                            <button class="nav-link filter-area-pr-suspend mr-2" type="button" role="tab"
                                attr="pending">Suspend Requests</button>
                            <button class="nav-link filter-area-pr-reactivate mr-2 " type="button" role="tab"
                                attr="reactivate">Reactivation Requests</button>
                        </div>
                    </nav>
                </div> <!-- /card-header -->
                <div class="card-body">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.pr.suspend', $customer->id) }}">
