    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('marketers') }}
                    </div>
                    <div class="col-sm-6 historyBTN">
                        @can('create',MarketerFullyQualifiedNameSpace())

                        <button class="btn btn-primary btn-sm">
                            <a href="{{ route('marketers.create') }}" class="btn btn-ctr">
                        ...
                        <button class="btn btn-danger btn-sm">
                            <a href="{{ route('marketers.trashed') }}" class="btn btn-ctr">
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="GET" action="{{ route('marketers.index') }}">
                                            @csrf
                                            <div class="row">
                    ...
                    <table class="table" id="my-table">
                        <thead>
                            <tr>
                                ...
                                <th>Phone</th>
                                <th>User</th>
                                @canany(['update', 'view', 'delete'], MarketerFullyQualifiedNameSpace())
                                <th>Operation</th>
                                @endcanany
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                @canany(['update', 'view', 'delete'], $marketer)
                                <td class="">
                                    <div class="action_dropdown_area">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                @can('delete', $marketer)
                                                <form method="post"
                                                    action="{{ route('marketers.destroy',$marketer->id) }}">
                                                    @csrf
                                                    @method('delete')
