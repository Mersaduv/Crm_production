    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Activated Customers Reports</h4>
                
                <div class="history">

                    <div class="row">
                        <div class="col-sm-6">
                           {{ Breadcrumbs::render('outsource.charts.activated') }}
                        </div>
                                ...
                                <div id="collapse-1" class="collapse" 
                                    ...
                                    <div class="card-body">
                                        <div class="panel-body">
                                            <form method="get" action="{{ route('outsource.charts.activated') }}">
                                                @csrf
                                                <div class="row">
