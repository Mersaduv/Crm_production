    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('tr.finance.requests') }}
                    </div>
                    <div class="col-sm-6 historyBTN">
                        <button type="button" class="btn btn-primary">
                            <a href="{{ route('trRequests.create') }}">
                                Add New
                            </a>
                        </button>
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('trRequests.index') }}">
                                            @csrf
                                            <div class="row">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{route('trRequests.show',$request->id)}}">
