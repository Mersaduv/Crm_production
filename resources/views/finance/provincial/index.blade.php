    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('finance.provincial') }}
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('prc.index') }}">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="debt_status" class="form-control"
                                                            ...
                                                            <option value="0">Complete Payment</option>
                                                        </select>
                                                    </div>
                                                </div> <!-- /col -->
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link provincial-filter-area mr-2" type="button" role="tab"
                                attr="active">Paid</button>
                            <button class="nav-link provincial-filter-area mr-2" type="button" role="tab"
                                attr="not-active">Not paid</button>
                        </div>
                    </nav>
                </div> <!-- /card-header -->
                <div class="card-body">
                                    ...
                                    <div class="action_dropdown_area">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="{{route('prc.show', $customer->id) }}">
