<div class="card-header">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link filter-area-pr-terminate mr-2 {{ request('attr') == 'terminate' ? 'active' : '' }}"
    ...
    <table class="table" id="my-table">
        <thead>
            <tr>
                ...
                @canany(['view'], ProvincialRecontractFullyQualifiedNameSpace())
                <th>Operation</th>
                @endcanany
            </tr>
        </thead>
                    ...
                    <div class="action_dropdown_area">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                @can('view', ProvincialRecontractFullyQualifiedNameSpace())
                                <a class="dropdown-item"
                                    href="{{route('pr.finance.recontract.details', $customer->id)}}">
