    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('finance.pr.amendments') }}
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('pr.fin.amends') }}">
                                            @csrf
                                            <div class="row">
                ...
                <div class="card-header">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link filter-area-prAmend mr-2" type="button" role="tab" attr="pending">
                                Amendment Requests
                                <span class="badge badge-info">
                                    {{ PrAmend('finance_confirmation')['penddingAmend'] }}
                                </span>
                            </button>
                            <button class="nav-link filter-area-canceled-prAmend mr-2" type="button" role="tab"
                                ...
                                Canceled Amendments
                                <span class="badge badge-info">
                                    {{ PrAmend('finance_confirmation')['canceledAmend'] }}
                                </span>
                            </button>
                        </div>
                    </nav>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{route('pr.fin.amend', $customer->id)}}">
