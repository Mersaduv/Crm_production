...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Terminated Customers</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('finance.pr.terminates') }}
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('pr.fin.terminates') }}">
                                            @csrf
                                            <div class="row">
                        ...
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link filter-area-pr-terminate mr-2" type="button" role="tab"
                                ...
                                <span class="badge badge-info">
                                    {{ PrTerminate('finance_confirmation')['terminates'] }}
                                </span>
                            </button>
                            <button class="nav-link filter-area-pr-recontract-terminate mr-2" type="button" role="tab"
                                ...
                                <span class="badge badge-info">
                                    {{ PrTerminate('finance_confirmation')['recontracts'] }}
                                </span>
                            </button>
                        </div>
                    </nav>
                    ...
                    <table class="table" id="my-table">
                        ...
                        <tbody id="pr_terminate_finance">
                            ...
                            <tr>
                                ...
                                <th>{{ $customer->terminate->first()->terminate_date }}</th>
                                @canany(['view'], ProvincialTerminateFullyQualifiedNameSpace())
                                <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{route('pr.fin.terminate', $customer->id)}}">
