<div class="card">
    ...
    <div class="card-body">
        ...
        @can('create', ProvincialReactivateFullyQualifiedNameSpace())
        @if(
        ...
        <button class="btn-primary btn w-100 mb-1">
            <a href="{{ route('pr.fin.activate',$customer->id) }}">
                Re-Activate
            </a>
        </button>
        @endif
        ...
        @can('update', ProvincialSuspendFullyQualifiedNameSpace())
        <button class="btn btn-primary w-100 mb-1" type="button" data-toggle="modal" data-target="#editSuspend">
            Edit Suspend
        </button>
        @endcan
        @can('delete', ProvincialSuspendFullyQualifiedNameSpace())
