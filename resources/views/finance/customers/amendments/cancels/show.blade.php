...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Amendment</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('finance.amedments.amend',$amend->amend->customer) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                                ...
                                <div class="media-29101 d-md-flex w-100">
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Education:</th>
                                                <td>{{ $amend->education }}</td>
                                            </tr>
                                            <tr>
                                                <th>Identity Number:</th>
                                                <td>{{ $amend->identity }}</td>
                                            </tr>
                                            <tr>
                                                <th>Address:</th>
                                                <td>{{ $amend->address }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($amend->discount_period)
                                                    <span>
                                                        {{ $amend->discount_period }}
                                                    </span>
                                                    <span>
                                                        {{ $amend->discount_period_currency }}
                                                    </span>
                                                    @else
                                                    NA
                                                    @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($amend->discount_reason)
                                                    {{ $amend->discount_reason }}
                                                    @else
                                                    NA
                                                    @endif
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $amend->equi_type }}</td>
                                            </tr>
                                            <tr>
                                                <th>Leased Type:</th>
                                                <td>
                                                    @if($amend->leased_type)
                                                    {{ $amend->leased_type }}
                                                    @else
                                                    NA
                                                    @endif
                                            ...
                                            <tr>
                                                <th>Receiver Type:</th>
                                                <td>{{ $amend->receiver_type }}</td>
                                            </tr>
                                            <tr class="price">
                                                <th>Receiver Price:</th>
                                                <td>
                                                    @if($amend->receiver_price)
                                                    <span>
                                                        {{ $amend->receiver_price }}
                                                    </span>
                                                    <span>
                                                        {{ $amend->receiver_price_currency }}
                                                    </span>
                                                    @else
                                                    NA
                                                    @endif
                                            ...
                                            <tr class="price">
                                                <th>Router Price:</th>
                                                <td>
                                                    @if($amend->router_price)
                                                    <span>
                                                        {{ $amend->router_price }}
                                                    </span>
                                                    <span>
                                                        {{ $amend->router_price_currency }}
                                                    </span>
                                                    @else
                                                    NA
                                                    @endif
                                            ...
                                            <tr class="price">
                                                ...
                                                <td>
                                                    @if($amend->Installation_cost)
                                                    <span>
                                                        {{ $amend->Installation_cost }}
                                                    </span>
                                                    <span>
                                                        {{ $amend->Installation_cost_currency }}
                                                    </span>
                                    ...
                                    <table class="table table-striped table-dark">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $amend->amend->amedment_comment }}</td>
                                            </tr>
                                            <tr>
                                                <th>Cancel Reason</th>
                                                <td>
                ...
                <div class="col-md-3">
                    @include('finance.customers.amendments.cancels.sidebar')
                </div> <!-- /col-3 -->
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        e.preventDefault();
            ...
            jQuery.ajax({
               url:"{{ route('cancel.amend.confirm') }}",
               method:'post',
               data:{
                    "_token": "{{ csrf_token() }}",
                    id:"{{ $amend->id }}",
