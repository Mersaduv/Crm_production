        ...
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link filter-area-amend mr-2 {{ request('attr') == 'pending' ? 'active' : '' }}"
                ...
                <span class="badge badge-info">
                    {{ amends('finance_confirmation')['penddingAmend'] }}
                </span>
            </button>
            <button class="nav-link filter-area-cancel-amend mr-2 {{ request('attr') == 'cancels' ? 'active' : '' }}"
                ...
                Canceled Amendments
                <span class="badge badge-info">
                    {{ amends('finance_confirmation')['canceledAmend'] }}
                </span>
            </button>
        </div>
    </nav>
                    ...
                    <div class="action_dropdown_area">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('finance.cancel.amedment',$customer->id) }}">
