    ...
    <table class="table" id="my-table">
        <thead>
            <tr>
                ...
                @canany(['view'], RecontractFullyQualifiedNameSpace())
                <th>Operation</th>
                @endcanany
            </tr>
        </thead>
                    ...
                    <div class="action_dropdown_area">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                @can('view', RecontractFullyQualifiedNameSpace())
                                <a class="dropdown-item" href="{{ route('finance.recontract.show', $customer->id) }}">
