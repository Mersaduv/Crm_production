...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Terminates</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('finance.terminates') }}
                    </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('finance.terminated') }}">
                                            @csrf
            ...
            <div class="card" id="filter-area-terminate">
                <div class="card-header">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link filter-area-terminate mr-2 active" type="button" role="tab"
                                attr="terminate">Terminates</button>
                            <button class="nav-link filter-area-terminate mr-2" type="button" role="tab" attr="pending">
                                Termination Requests
                                <span class="badge badge-info">
                                    {{ terminates('finance_confirmation')['terminates'] }}
                                </span>
                            </button>
                            <button class="nav-link filter-area-recontract mr-2" type="button" role="tab"
                                attr="recontract">
                                Recontraction Requests
                                <span class="badge badge-info">
                                    {{ terminates('finance_confirmation')['recontracts'] }}
                                </span>
                            </button>
                        </div>
                    </nav>
                ...
                <div class="card-body">
                    <table class="table" id="my-table">
                        ...
                        <tbody id="finance_table_terminate">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('finance.terminate', $customer->id) }}">
