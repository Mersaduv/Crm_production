    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('noc.show',$customer) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                ...
                <div class="col-md-3">
                    @include('noc.customers.portion.sidebar')
                </div> <!-- /col-3 -->
    ...
    <div class="modal" id="suspendModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('noc.suspend',$customer->id) }}">
                    @csrf
                    @method('put')
    ...
    <div class="modal" id="cancelModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('cancels.store') }}">
                    @csrf
                ...
                <form method="post" action="{{ route('cancels.update',$customer->cancel->first()->id) }}">
                    @csrf
                    @method('put')
