    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('noc.terminate',$customer) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                ...
                <div class="col-md-3">
                    @include('noc.customers.terminates.sidebar')
                </div> <!-- /col-3 -->
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        jQuery('.cancel_btn').off().on('click',function(e){
            e.preventDefault();

            jQuery.ajax({
                url:"{{ route('terminate.cancel') }}",
                method:'post',
                data:{
                    "_token": "{{ csrf_token() }}",
                    id:"{{ $customer->terminate->first()->id }}",
                ...
                success:function(response){
                    ...
                    location.replace(BASE_URL+"/dashboard/installation/customers/terminates");
                }
                }
            });
