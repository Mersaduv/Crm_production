    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('noc.terminates') }}
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('installation.terminates') }}">
                                            @csrf
                                            <div class="row">
                        ...
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link filter-area-terminate mr-2" type="button" role="tab" attr="pending">
                                ...
                                <span class="badge badge-info">
                                    {{ terminates('noc_confirmation')['terminates'] }}
                                </span>
                            </button>
                            <button class="nav-link filter-area-recontract mr-2" type="button" role="tab"
                                ...
                                <span class="badge badge-info">
                                    {{ terminates('noc_confirmation')['recontracts'] }}
                                </span>
                            </button>
                        </div>
                    </nav>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('noc.terminate', $customer->id) }}">
