        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <div class="history">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            {{ Breadcrumbs::render('noc.cancel.show',$customer) }}
                        </div>
        ...
        <div class="col-sm-12">
            <div class="page-content-box">
                <div class="row">
                                    ...
                                    <div class="media-29101  w-100">
                                        <table class="table table-striped table-dark">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Created At:</th>
                                                    <td>{{ $customer->cancel->first()->created_at }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Cancel By</th>
                    ...
                    <div class="col-md-3">
                       @include('noc.customers.cancels.sidebar')
                    </div> <!-- /col-3 -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              @else
               ...
               <form method="post" 
                    action="{{ route('cancels.update',$customer->cancel->first()->id) }}">
                    @csrf
                    @method('put')
