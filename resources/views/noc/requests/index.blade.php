    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('noc.terminate.requests') }}
                    </div>
                    <div class="col-sm-6 historyBTN">
                        <button type="button" class="btn btn-primary">
                            <a href="{{ route('NocRequests.create') }}">
                                Add New
                            </a>
                        </button>
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('NocRequests.index') }}">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="sender">Request By:</label>
                                                        <input type="text" name="sender" class="form-control"
                                                            id="sender" autocomplete="off" placeholder="Request By" />
                                                    </div>
                                                </div> <!-- /col -->
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('NocRequests.show',$request->id) }}">
