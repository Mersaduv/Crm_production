    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('noc.pr.suspend',$customer) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                ...
                <div class="col-md-3">
                    @include('noc.provincial.suspends.sidebar')
                </div> <!-- /col-3 -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" id="formID"
                    action="{{ route('pr.noc.suspend.edit',$customer->suspend->first()->id) }}">
                    @csrf
                    @method('put')
    ...
    <div class="modal" id="deleteSuspend">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" id="formID"
                    action="{{ route('pr.noc.suspend.delete',$customer->suspend->first()->id) }}">
                    @csrf
                    @method('delete')
