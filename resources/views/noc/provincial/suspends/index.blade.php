    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('noc.pr.suspends') }}
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('pr.noc.suspends') }}">
                                            @csrf
                                            <div class="row">
                        ...
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link filter-area-pr-suspend mr-2" type="button" role="tab"
                                ...
                                <span class="badge badge-info">
                                    {{ PrSuspend('noc_confirmation')['suspends'] }}
                                </span>
                            </button>
                            <button class="nav-link filter-area-pr-reactivate mr-2 " type="button" role="tab"
                                ...
                                <span class="badge badge-info">
                                    {{ PrSuspend('noc_confirmation')['reactives'] }}
                                </span>
                            </button>
                        </div>
                    </nav>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('pr.noc.suspend', $customer->id) }}">
