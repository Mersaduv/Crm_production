    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('noc.provincial.name',$customer) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                ...
                <div class="col-md-3">
                    @include('noc.provincial.portion.sidebar')
                </div> <!-- /col-3 -->
    ...
    <div class="modal" id="suspendModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('pr.noc.suspend.process',$customer->id) }}">
                    @csrf
                    @method('put')
    ...
    <div class="modal" id="cancelModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{ route('prCancels.update',$customer->prCancel->id) }}">
                    @csrf
                    @method('put')
