            ...
            <div class="page-content-box">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" 
                              action="{{ route('prCustomers.update',$customer->PrNocInfo->id) }}">
                            @csrf
                            @method('put')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" 
                                               ...
                                               class="form-control"
                                               value="{{ Carbon\Carbon::parse($customer->PrNocInfo->installation_date)->format('Y-m-d') }}" 
                                               id="activation_date" 
                                               autocomplete="off" 
                                               required="required" 
                                            />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               name="latitiude"
                                               class="form-control"
                                               value="{{ $customer->PrNocInfo->latitiude }}" 
                                               id="latitiude" 
                                               autocomplete="off"
                                            />
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               name="longitude"
                                               class="form-control"
                                               value="{{ $customer->PrNocInfo->longitude }}"
                                               id="longitude" 
                                               autocomplete="off"
                                            />
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" 
                                               name="additional_fee"
                                               class="form-control"
                                               value="{{ $customer->PrNocInfo->additional_fee }}"
                                               id="additional_fee" 
                                               autocomplete="off" 
                                               required="required"  
                                            />
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               class="form-control"
                                               value="{{ $customer->PrNocInfo->additional_fee_price }}"
                                        ...
                                        <div class="input-group-append">
                                            <select class="form-control" name="additional_fee_currency">
                                               <option value="AFG" {{ $customer->PrNocInfo->    
                                                    additional_fee_currency=='AFG'?'selected':''}}>
                                                    AFG
                                                </option>
                                                <option value="Dollar" {{ $customer->PrNocInfo->additional_fee_currency=='Dollar'?'selected':''}}>
                                                    Dollar
                                                </option>
                                            </select>
                                        </div>
