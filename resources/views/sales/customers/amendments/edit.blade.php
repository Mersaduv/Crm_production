    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Customer Amendment Edit</h4>
            ...
            <div class="page-content-box">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('customer.amedment.updateAmendment',$customer->id) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               class="form-control" 
                                               autocomplete="off" 
                                               value="{{ $customer->customer->sale->package ? $customer->customer->sale->package->name : '' }}" 
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               autocomplete="off" 
                                               class="form-control" 
                                               value="{{ $customer->customer->sale->commission ? $customer->customer->sale->commission->name : '' }}"
                                            />
                                        <ul id="commission_list"></ul>
                                        <input type="hidden" 
                                              name="commission_id" 
                                              id="commission_id"
                                              value="{{ $customer->customer->sale->commission ? $customer->customer->sale->commission->id : '' }}"  
                                            />
                                    </div>
                                </div> <!-- /col -->
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                                ...
                                                class="form-control"
                                                autocomplete="off"
                                                value="{{ $customer->commission_percent }}" />
                                    </div>
                                </div> <!-- /col -->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" 
                                            ...
                                            <option value="sell" {{ $customer->equi_type == 'sell' ? 'selected' : '' }}>
                                                Sell
                                            </option>
                                            <option value="leased" {{ $customer->equi_type == 'leased' ? 'selected' : '' }}>
                                                Leased
                                            </option>
                                            <option value="own" {{ $customer->equi_type == 'own' ? 'selected' : '' }}>
                                                Own
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="leased_type" 
                                            ...
                                            <option value="full" {{ $customer->leased_type == 'full' ? 'selected' : '' }}>
                                                Full
                                            </option>
                                            <option value="guarantee" {{ $customer->leased_type == 'guarantee' ? 'selected' : '' }}>
                                                Guarantee
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <select class="form-control" name="discount_currency">
                                                <option value="AFG" {{ $customer->discount_currency == 'AFG' ? 'selected' : '' }}>
                                                    AFG
                                                </option>
                                                <option value="Dollar" {{ $customer->discount_currency == 'Dollar' ? 'selected' : '' }}>
                                                    Dollar
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="number"
                                           ...
                                           class="form-control"
                                           value="{{ $customer->discount_period }}" 
                                        />
                                        <div class="input-group-append">
                                            <select class="form-control" name="discount_period_currency" id="discount_period_currency">
                                                <option value="Days" {{ $customer->discount_period_currency == 'Days' ? 'selected' : '' }}>
                                                    Days
                                                </option>
                                                <option value="Months" {{ $customer->discount_period_currency == 'Months' ? 'selected' : '' }}>
                                                    Months
                                                </option>
                                                <option value="Package" {{ $customer->discount_period_currency == 'Package' ? 'selected' : '' }}>
                                                    Package
                                                </option>
                                                <option value="Permanent" {{ $customer->discount_period_currency == 'Permanent' ? 'selected' : '' }}>
                                                    Permanent
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                           ...
                                           class="form-control"
                                           value="{{ $customer->discount_reason }}" 
                                        />
                                    </div>
                                </div> <!-- /col -->
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ $customer->receiver_price }}"
                                               autocomplete="off" 
                                               />
                                        <div class="input-group-append">
                                            <select class="form-control" name="receiver_price_currency">
                                                <option value="AFG" {{ $customer->receiver_price_currency == 'AFG' ? 'selected' : '' }}>
                                                    AFG
                                                </option>
                                                <option value="Dollar" {{ $customer->receiver_price_currency == 'Dollar' ? 'selected' : '' }}>
                                                    Dollar
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ $customer->router_price }}"
                                               autocomplete="off" 
                                               />
                                        <div class="input-group-append">
                                            <select class="form-control" name="router_price_currency">
                                                <option value="AFG" {{ $customer->router_price_currency == 'AFG' ? 'selected' : '' }}>
                                                    AFG
                                                </option>
                                                <option value="Dollar" {{ $customer->router_price_currency == 'Dollar' ? 'selected' : '' }}>
                                                    Dollar
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ $customer->cable_price }}" 
                                               autocomplete="off" 
                                               required="required" 
                                            />
                                        <div class="input-group-append">
                                            <select class="form-control" name="cable_price_currency">
                                                <option value="AFG" {{ $customer->cable_price_currency == 'AFG' ? 'selected' : '' }}>
                                                    AFG
                                                </option>
                                                <option value="Dollar" {{ $customer->cable_price_currency == 'Dollar' ? 'selected' : '' }}>
                                                    Dollar
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <select class="form-control" name="Installation_cost_currency">
                                                ...
                                                <option value="Dollar" {{ $customer->Installation_cost_currency == 'Dollar' ? 'selected' : '' }}>
                                                    Dollar
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" 
                                               ...
                                               id="amedment_date"
                                               class="form-control"
                                               placeholder="Amedment Date:" 
                                               required="amedment_date"
                                               value="{{ $customer->amend_date }}" 
                                            />
                                    </div>
                                </div> <!-- /col -->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="amedment_comment"
                                                  class="form-control"
                                                  id="amedment_comment"
                                                  required="required" 
                                                  placeholder="Amedment Comment:">{{ $customer->amedment_comment ? $customer->amedment_comment : '' }}</textarea>
                                    </div>
                                </div> <!-- /col -->
                            </div> <!-- /row -->
