    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('sales.customers.cancels.amends') }}
                    </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-content-box">
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('customers.ameds.cancels') }}">
                                            @csrf
                                            <div class="row">
            ...
            <div class="card" id="filter-area-cancel-amend">
                <div class="card-header">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link filter-area-cancel-amend active" type="button" role="tab"
                                attr="all">All</button>
                            <button class="nav-link filter-area-cancel-amend" type="button" role="tab"
                    ...
                    <table class="table" id="my-table">
                        <thead>
                            <tr>
                                ...
                                <th>Cancel Date</th>
                                @canany(['view'], CancelAmendmentFullyQualifiedNameSpace())
                                <th>Operation</th>
                                @endcanany
                            </tr>
                        </thead>
                                    ...
                                    <div class="action_dropdown_area">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                @can('view', CancelAmendmentFullyQualifiedNameSpace())
                                                <a class="dropdown-item"
                                                    href="{{ route('customers.amed.cancel', $customer->id) }}">
