                        ...
                        <div class="row">
                            <div class="col-sm-6">
								...
								?>
                                    ...
                                    <tr
                                        class="<?php echo ($customer->package_price != $clone->package_price) || ($customer->package_id != $clone->package_id) ? 'price' : '' ?>">
                                        <th>قیمت بسته</th>
                                        <td>
                                    ...
                                    <tr
                                        class="<?php echo ($customer->receiver_price != $clone->receiver_price) || ($customer->receiver_type != $clone->receiver_type) ? 'price' : '' ?>">
                                    ...
                                    <tr
                                        class="<?php echo ($customer->router_price != $clone->router_price) || ($customer->router_type != $clone->router_type) ? 'price' : '' ?>">
