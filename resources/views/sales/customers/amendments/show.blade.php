    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('sales.customers.amend', $customer->customer) }}
                    </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                                ...
                                <div class="media-29101  w-100">
                                    <table class="table table-striped table-dark">
                                        <tbody>
                                            ...
                                            @endif
                                            @isset($customer->full_name_persian)
                                            @if ($customer->full_name_persian != $clone->full_name_persian)
                                            <tr>
                                                <th>Full Name Persian</th>
                                                <td>
                                                    {{ $clone->full_name_persian }}
                                                    =>
                                                    {{ $customer->full_name_persian }}
                                                </td>
                                            </tr>
                                            @endif
                                            @endisset
                                            ...
                                            @endif
                                            @isset($customer->poc_persian)
                                            @if ($customer->poc_persian != $clone->poc_persian)
                                            <tr>
                                                <th>POC Persian</th>
                                                <td>
                                                    {{ $clone->poc_persian }}
                                                    =>
                                                    {{ $customer->poc_persian }}
                                                </td>
                                            </tr>
                                            @endif
                                            @endisset
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $clone->discount_period }}
                                                    {{ $clone->discount_period_currency }}
                                                    =>
                                                    {{ $customer->discount_period }}
                                                    {{ $customer->discount_period_currency }}
                                                </td>
                                            ...
                                            <tr>
                                                <th>Receiver Price</th>
                                                <td>
                                                    {{ $clone->receiver_price }}
                                                    {{ $clone->receiver_price_currency }}
                                                    =>
                                                    {{ $customer->receiver_price }}
                                                    {{ $customer->receiver_price_currency }}
                                                </td>
                                            ...
                                            <tr>
                                                <th>Additional Charge Price</th>
                                                <td>
                                                    {{ $clone->additional_charge_price }}
                                                    {{ $clone->additional_currency }}
                                                    =>
                                                    {{ $customer->additional_charge_price }}
                                                    {{ $customer->additional_currency }}
                                                </td>
                ...
                <div class="col-md-3">
                    @include('sales.customers.amendments.sidebar')
                </div> <!-- /col-3 -->
    ...
    <!-- The Modal -->
    <div class="modal" id="deleteAmendment">
        <div class="modal-dialog">
            <div class="modal-content">

                <form method="post" id="formID" action="{{ route('customer.amedment.delete', $customer->id) }}">
                    @csrf
                    @method('delete')

                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title">Delete Amendment</h4>
