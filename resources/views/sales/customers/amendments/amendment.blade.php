...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Customer Details Amedmentation</h4>

            <div class="history">

                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('salesCustomerAmedment', $customer) }}
                    </div>
        ...
        <div class="page-content-box">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('customer.amedmentation', $customer->id) }}">
                        @csrf
                        @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name_persian" class="form-control"
                                        placeholder="Full Name Persian" value="{{ $customer->full_name_persian }}"
                                        id="full_name_persian" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="poc" class="form-control" placeholder="POC"
                                        value="{{ $customer->poc }}" id="poc" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="poc_persian" class="form-control" placeholder="POC"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone1" class="form-control" placeholder="Phone 1"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="education" class="form-control" placeholder="Education"
                                        value="{{ $customer->education }}" id="education" autocomplete="off"
                                        required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="identity_num" class="form-control"
                                        placeholder="Identity Number:" value="{{ $customer->identity_num }}"
                                        id="identity_num" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="package_price" id="package_price" class="form-control"
                                        value="{{ $customer->sale->package_price }}" required="required"
                                        autocomplete="off" />
                                    ...
                                    <div class="input-group-append">
                                        <select class="form-control" name="package_price_currency">
                                            <option value="AFG" {{ $customer->sale->package_price_currency == 'AFG' ?
                                                'selected' : '' }}>
                                                AFG
                                            </option>
                                            <option value="Dollar" {{ $customer->sale->package_price_currency ==
                                                'Dollar' ? 'selected' : '' }}>
                                                Dollar
                                            </option>
                                        </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="equi_type" id="equi_type" required="required">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="leased_type" id="leased_type">
                                        <option value="">Select Leased:</option>
                                        <option value="full" {{ $customer->sale->leased_type == 'full' ? 'selected' : ''
                                            }}>
                                            Full
                                        </option>
                                        <option value="guarantee" {{ $customer->sale->leased_type == 'guarantee' ?
                                            'selected' : '' }}>
                                            Guarantee
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="previous_discount"
                                        value="{{ $customer->sale->discount }}">
                                    <input type="number" name="discount" id="discount" placeholder="Discount:"
                                        value="{{ $customer->sale->discount }}" class="form-control" />
                                    <div class="input-group-append">
                                        <select class="form-control" name="discount_currency">
                                            <option value="AFG" {{ $customer->sale->discount_currency == 'AFG' ?
                                                'selected' : '' }}>
                                                AFG
                                            </option>
                                            <option value="Dollar" {{ $customer->sale->discount_currency == 'Dollar' ?
                                                'selected' : '' }}>
                                                Dollar
                                            </option>
                                        </select>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="previous_discount_period"
                                        value="{{ $customer->sale->discount_period }}">
                                    <input type="number" name="discount_period" id="discount_period"
                                        placeholder="Discount Period:" class="form-control"
                                        value="{{ $customer->sale->discount_period }}" />
                                    <div class="input-group-append">
                                        <select class="form-control" name="discount_period_currency"
                                            id="discount_period_currency">
                                            <option value="Days" {{ $customer->sale->discount_period_currency == 'Days'
                                                ? 'selected' : '' }}>
                                                Days
                                            </option>
                                            <option value="Months" {{ $customer->sale->discount_period_currency ==
                                                'Months' ? 'selected' : '' }}>
                                                Months
                                            </option>
                                            <option value="Package" {{ $customer->sale->discount_period_currency ==
                                                'Package' ? 'selected' : '' }}>
                                                Package
                                            </option>
                                            <option value="Permanent" {{ $customer->sale->discount_period_currency ==
                                                'Permanent' ? 'selected' : '' }}>
                                                Permanent
                                            </option>
                                        </select>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="previous_discount_reason"
                                        value="{{ $customer->sale->discount_reason }}">
                                    <input type="text" name="discount_reason" id="discount_reason"
                                        placeholder="Discount Reason:" class="form-control"
                                        value="{{ $customer->sale->discount_reason }}" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="receiver_type" id="receiver_type" class="form-control"
                                        placeholder="Receiver Type:" value="{{ $customer->sale->receiver_type }}"
                                        autocomplete="off" required="required" />
                                    <ul id="receiver_type_list"></ul>
                                    <input type="hidden" name="receiver_type_id" id="receiver_type_id"
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <select class="form-control" name="receiver_price_currency">
                                            ...
                                            <option value="Dollar" {{ $customer->sale->receiver_price_currency ==
                                                'Dollar' ? 'selected' : '' }}>
                                                Dollar
                                            </option>
                                        </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="router_type" id="router_type" class="form-control"
                                        autocomplete="off" placeholder="Router Type:"
                                        value="{{ $customer->sale->router_type }}" />
                                    <ul id="router_type_list"></ul>
                                    <input type="hidden" name="router_type_id" id="router_type_id"
                                        value="{{ $customer->sale->router_type }}">
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="previous_router_price"
                                        value="{{ $customer->sale->router_price }}">
                                    <input type="number" name="router_price" id="router_price" class="form-control"
                                        placeholder="Router Price:" value="{{ $customer->sale->router_price }}"
                                        autocomplete="off" />
                                    <div class="input-group-append">
                                        <select class="form-control" name="router_price_currency">
                                            <option value="AFG" {{ $customer->sale->router_price_currency == 'AFG' ?
                                                'selected' : '' }}>
                                                AFG
                                            </option>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="previous_cable_price"
                                        value="{{ $customer->sale->cable_price }}">
                                    <input type="number" name="cable_price" class="form-control" id="cable_price"
                                        placeholder="Cable Price:" value="{{ $customer->sale->cable_price }}"
                                        autocomplete="off" required="required" />
                                    <div class="input-group-append">
                                        <select class="form-control" name="cable_price_currency">
                                            <option value="AFG" {{ $customer->sale->cable_price_currency == 'AFG' ?
                                                'selected' : '' }}>
                                                AFG
                                            </option>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="previous_Installation_cost"
                                        value="{{ $customer->sale->Installation_cost }}">
                                    <input type="number" name="Installation_cost" id="Installation_cost"
                                        class="form-control" placeholder="Installation Cost:" autocomplete="off"
                                        value="{{ $customer->sale->Installation_cost }}" />
                                    <div class="input-group-append">
                                        <select class="form-control" name="Installation_cost_currency">
                                            ...
                                            <option value="Dollar" {{ $customer->sale->Installation_cost_currency ==
                                                'Dollar' ? 'selected' : '' }}>
                                                Dollar
                                            </option>
                                        </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="amedment_date" class="required">
                                        Amedment Date:
                                    </label>
                                    <input type="date" name="amedment_date" id="amedment_date" class="form-control"
                                        placeholder="Amedment Date:" value="" required="amedment_date" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="public_ip" id="public_ip" class="form-control"
                                        placeholder="Public IP:" autocomplete="off"
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <select class="form-control" name="ip_price_currency">
                                            <option value="AFG" {{ $customer->sale->ip_price_currency == 'AFG' ?
                                                'selected' : '' }}>
                                                AFG
                                            </option>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="previous_additional_charge_price"
                                    ...
                                    <div class="input-group-append">
                                        <select class="form-control" name="additional_currency">
                                            <option value="AFG" {{ $customer->sale->additional_currency == 'AFG' ?
                                                'selected' : '' }}>
                                                AFG
                                            </option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="amedment_comment" class="required">
                                        Amedment Coment:
                                    </label>
                                    <textarea name="amedment_comment" class="form-control" id="amedment_comment"
                                        required="required" placeholder="Amedment Comment:"></textarea>
                                </div>
                            </div> <!-- /col -->
                        </div> <!-- /row -->
