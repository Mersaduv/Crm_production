    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('salesAddCustomer') }}
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customer_id" class="form-control" placeholder="Customer ID"
                                        id="id" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name" class="form-control" placeholder="Full Name"
                                        id="full_name" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name_persian" class="form-control"
                                        placeholder="Full Name Persian" id="full_name_persian" autocomplete="off"
                                        required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="poc" class="form-control" placeholder="POC" id="poc"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="poc_persian" class="form-control" placeholder="POC Persian"
                                        id="poc_persian" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone1" class="form-control" placeholder="Phone 1"
                                        id="phone1" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone2" class="form-control" placeholder="Phone 2"
                                        id="phone2" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="education" class="form-control" placeholder="Education"
                                        id="education" autocomplete="off" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="identity_num" class="form-control"
                                        placeholder="Identity Number:" id="identity_num" autocomplete="off"
                                        required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="province" id="province" class="form-control">
                                        ...
                                        <option value="{{ $province->name }}">{{ province($province->name) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div> <!-- /col-->
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="package" id="package" autocomplete="off"
                                        class="form-control" placeholder="Package Name:" required="required" />
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="package_price" id="package_price" class="form-control"
                                        placeholder="Package Price:" required="required" autocomplete="off" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="commission" id="commission" autocomplete="off"
                                        class="form-control" placeholder="Reseller Name:" />
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="commission_percent" id="commission_percent"
                                        class="form-control" autocomplete="off" placeholder="Reseller Percent:" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="receiver_type" id="receiver_type" class="form-control"
                                        placeholder="Receiver Type:" autocomplete="off" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="router_type_id" id="router_type_id" value="" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="cable_price" class="form-control" id="cable_price"
                                        placeholder="Cable Price:" required="required" />
                                    <div class="input-group-append">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="installation_date" id="installation_date"
                                        class="form-control" placeholder="Installation Date:" required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="Installation_cost" id="Installation_cost"
                                        class="form-control" required="required" placeholder="Installation Cost:" />
                                    <div class="input-group-append">
