...
<body>
<h1>Terminated Customer Recontraction Details</h1>	
<table class="table">
<tbody>
<tr>
<th>Customer ID:</th>
...
<tr>
<th>Re-Contraction Date:</th>
<td>
@if($customer->terminate->first()->recontract_date)
{{ $customer->terminate->first()->recontract_date }}
@else
NA
@endif
</td>
