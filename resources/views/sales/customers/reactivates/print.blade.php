    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="page-header-box">
                                ...
                                <h6 style="font-size: 11px">نماینده رسمی شرکت اتصالات</h6>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
								...
								?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ Carbon\Carbon::parse($customer->reactivation_date)->format('Y-m-d') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>بسته اینترنتی</th>
        ...
        <script type="text/javascript">
			...
			try {
			  ...
			  window.location.href = "{{ route('suspends.reactivates.show',$customer->id)}}";
			}
