...
@section('content')
        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <div class="history">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            {{ Breadcrumbs::render('singleTerminate', $customer) }}
                        </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-content-box">
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex carousel-nav">
                                    ...
                                    <a href="#" class="col">Terminate Details</a>
                                </div>
                                        ...
                                        <table class="table table-striped">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ Carbon\Carbon::parse($customer->sale->installation_date)->format('Y-m-d') }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Public IP:</th>
                                        ...
                                        <table class="table table-striped table-dark">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $customer->terminate->first()->termination_date }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th>Created At</th>
                                                    <td>{{ $customer->terminate->first()->created_at }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div> <!-- .item -->
                    ...
                    <div class="col-md-3">
                        @include('sales.customers.terminates.sidebar')
                    </div> <!-- /col-3 -->
        ...
        <!-- The Modal -->
        <div class="modal" id="editTerminate">
            <div class="modal-dialog">
                <div class="modal-content">

                    <form method="post" id="formID"
                        action="{{ route('terminate.edit', $customer->terminate->first()->id) }}">
                        @csrf
                        @method('put')

                        <!-- Modal Header -->
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Terminate</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="termination_date">Terminate Date:</label>
                                <input type="date" name="termination_date" id="termination_date" class="form-control"
                                    required="required" value="{{ $customer->terminate->first()->termination_date }}" />
                            </div>

                            <div class="form-group">
                                <label for="terminate_reason">Terminate Reason:</label>
                                <textarea class="form-control" name="terminate_reason" id="terminate_reason" placeholder="Suspend Reason" rows="5"
                                    required="required">{{ $customer->terminate->first()->terminate_reason }}</textarea>
                            </div>
        ...
        <!-- The Modal -->
        <div class="modal" id="deleteTerminate">
            <div class="modal-dialog">
                <div class="modal-content">

                    <form method="post" id="formID"
                        action="{{ route('terminate.delete', $customer->terminate->first()->id) }}">
                        @csrf
                        @method('delete')

                        <!-- Modal Header -->
                        <div class="modal-header">
                            <h4 class="modal-title">Delete Terminate</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>
