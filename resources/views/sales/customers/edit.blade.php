    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('salesCustomerEdit',$customer) }}
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <ul id="packages_list" style="display: block; position: absolute; z-index: 1"></ul>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="receiver_type" id="receiver_type" class="form-control"
                                        ...
                                        autocomplete="off" list="receiver_type_list" />
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <select class="form-control" name="receiver_price_currency">
                                            <option value="AFG" {{ $customer->sale->
                                                receiver_price_currency == 'AFG' ? 'selected' : '' }}>
                                                AFG
                                            </option>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <select class="form-control" name="router_price_currency">
                                            <option value="AFG" {{ $customer->sale->
                                                router_price_currency == 'AFG' ? 'selected' : '' }}>
                                                AFG
                                            </option>
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <select class="form-control" name="cable_price_currency">
                                            <option value="AFG" {{ $customer->sale->
                                                cable_price_currency == 'AFG' ? 'selected' : '' }}>
                                                AFG
                                            </option>
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <label for="Installation_cost" class="required">
                                        Installation Cost:
                                    </label>
                                    <input type="number" name="Installation_cost" id="Installation_cost"
                                        ...
                                        required="required" value="{{ $customer->sale->Installation_cost }}" />
                                    <div class="input-group-append">
                                        <select class="form-control" name="Installation_cost_currency">
                                            <option value="AFG" {{ $customer->sale->
                                                Installation_cost_currency == 'AFG' ? 'selected' : '' }}>
                                                AFG
                                            </option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="installation_date" id="installation_date"
                                        class="form-control" placeholder="Installation Date:"
                                        value="{{ Carbon\Carbon::parse($customer->sale->installation_date)->format('Y-m-d') }}"
                                        required="required" />
                                </div>
                            </div> <!-- /col -->
