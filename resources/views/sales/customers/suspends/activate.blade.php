    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Activate Customer Details</h4>
                
                <div class="history">

                    <div class="row">
                        <div class="col-sm-6">
                            {{ Breadcrumbs::render('salesCustomerActivate',$customer) }}
                        </div>
            ...
            <div class="page-content-box">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('customer.activate',$customer->id) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="reactivation_date" class="required">
                                            Re-Activation Date: 
                                        </label>
                                        <input type="date" 
                                               ...
                                               class="form-control"
                                               placeholder="Re-Activation Date:" 
                                               value="" 
                                               required="reactivation_date" 
                                               />
                                    </div>
                                </div> <!-- /col -->
