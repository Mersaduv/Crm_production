    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Reactivate Customer</h4>
                
                <div class="history">

                    <div class="row">
                        <div class="col-sm-6">
                           {{ Breadcrumbs::render('sales.provincial.reactive',$customer) }}
                        </div>
            ...
            <div class="page-content-box">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('pr.activating',$customer->id) }}">
                            @csrf
                            @method('put')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="reactive_date" class="required">
                                            Re-activation Date:
                                        </label>
                                        <input type="date" 
                                               name="reactive_date"
