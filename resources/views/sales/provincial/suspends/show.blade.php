    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('sales.pr.suspend',$customer) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                ...
                <div class="col-md-3">
                    @include('sales.provincial.suspends.sidebar')
                </div> <!-- /col-3 -->
    ...
    <div class="modal" id="editSuspend">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" id="formID" action="{{ route('pr.suspend.edit',$customer->suspend->first()->id) }}">
                    @csrf
                    @method('put')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="suspend_date" id="suspend_date" class="form-control"
                                required="required" value="{{ $customer->suspend->first()->suspend_date }}" />
                        </div>

                        <div class="form-group">
                            <label for="suspend_reason">Suspend Reason:</label>
                            <textarea class="form-control" name="suspend_reason" id="suspend_reason"
                                placeholder="Suspend Reason" rows="5"
                                required="required">{{ $customer->suspend->first()->suspend_reason }}</textarea>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" id="formID"
                    action="{{ route('pr.suspend.delete',$customer->suspend->first()->id) }}">
                    @csrf
                    @method('delete')
