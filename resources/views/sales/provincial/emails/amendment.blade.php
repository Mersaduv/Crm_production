...
<body>
<h1>Provincial Amendment Details</h1>
...
<th>Amend Comment</th>
<td>
{{ $customer->amend->first()->amend_comment }}
</td>
</tr>
<tr>
<th>Updater</th>
...
<th>Customer ID</th>
<td>
{{ $customer->amend->first()->customer_id }}
</td>
</tr>
<tr>
<th>Full Name</th>
...
<tr>
<th>Province</th>
<td>{{ province($customer->amend->first()->province) }}</td>
</tr>
<tr>
<th>Customre Province</th>
<td>{{ province($customer->amend->first()->customerProvince); }}</td>
</tr>
<tr>
<th>Address</th>
...
<tr>
<th>Reseller Name</th>
<td>{{ $customer->amend->first()->commission ? $customer->amend->first()->commission->name : 'NA' }}</td>
</tr>
<tr>
...
<tr>
<th>Service</th>
<td>{{ $customer->amend->first()->service }}</td>
</tr>
<tr>
<th>Provider</th>
<td>{{ $customer->amend->first()->provider }}</td>
</tr>
<tr>
<th>Public IP</th>
<td>
