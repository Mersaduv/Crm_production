    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Edit Amendment</h4>
                    ...
                    <div class="filter-area">
                        ...
                        <div id="accordion-2" role="tablist">
                            ...
                            <div class="card shadow-none mb-0">
                                ...
                                <div id="collapse-1" class="collapse resellersCard" 
            ...
            <div class="page-content-box">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('pr.amedment.updateAmendment',$customer->id) }}">
                            @csrf
                            @method('put')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="customerProvince" id="customerProvince" class="form-control">
                                            ...
                                            @foreach($provinces as $province)
                                                <option value="{{ $province->name }}" {{ $customer->customerProvince == $province->name ? 'selected' : ''}}>{{ province($province->name) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div> <!-- /col-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="commission" class="required">
                                            Reseller:
                                        </label>
                                        <input type="text" 
                                               name="commission" 
                                	 ...
                                	 <div class="form-group">
                                	 	<label for="service" class="required">Service Type:</label>
                                	 	 <select class="form-control" 
                                	 	 	...
                                	 	 	<option value="VSAT" 
                                	 	 		{{ $customer->service=="VSAT" ? "selected" : "" }}>
                                	 	 		VSAT
                                	 	 	</option>
                                	 	 	<option value="Wireless" 
                                	 	 		{{ $customer->service=="Wireless" ?"selected" : "" }}>
                                	 	 		Wireless
                                	 	 	</option>
                                	 	 	<option value="Microwave" 
                                	 	 		{{ $customer->service=="Microwave" ? "selected" : "" }}>
                                	 	 		Microwave
                                	 	 	</option>
                                	 	 </select>
                                	 </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="amend_date" class="required">
                                            Amendment Date:
                                        </label>
                                        <input type="date" 
                                               name="amend_date"
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <select class="form-control" name="Installation_cost_currency">
                                                <option value="AFG" 
                                                	{{ $customer->Installation_cost_currency == 'AFG'
                                                				  ? 'selected' : '' }}>
                                                    AFG
                                                </option>
                                                <option value="Dollar" 
                                                	{{ $customer->Installation_cost_currency =='Dollar' 
                                                	              ? 'selected' : '' }}>
                                                    Dollar
                                                </option>
                                            </select>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <select class="form-control" name="ip_price_currency">
                                                <option value="AFG" 
                                                	{{ $customer->ip_price_currency == 'AFG'
                                                				  ? 'selected' : '' }}>
                                                    AFG
                                                </option>
                                                <option value="Dollar" 
                                                	{{ $customer->ip_price_currency =='Dollar' 
                                                	              ? 'selected' : '' }}>
                                                    Dollar
                                                </option>
                                            </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="amend_comment" class="required">
                                            Amendment Comment:
                                        </label>
                                        <textarea name="amend_comment" 
                                        		  class="form-control"
                                        		  required="required"
                                        		  id="amend_comment" placeholder="Reason">{{ $customer->amend_comment }}</textarea>
                                    </div>
                                </div> <!-- /col -->
                            </div> <!-- /row -->
