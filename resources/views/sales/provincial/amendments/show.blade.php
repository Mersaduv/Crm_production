    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('sales.pr.amend', $customer->provincial) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                                ...
                                <div class="media-29101 d-md-flex w-100">
                                    <table class="table table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Provider</th>
                                                @if ($customer->provincial->provider->name)
                ...
                <div class="col-md-3">
                    @include('sales.provincial.amendments.sidebar')
                </div> <!-- /col-3 -->
    ...
    <div class="modal" id="delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" id="formID" action="{{ route('pr.amedment.delete', $customer->id) }}">
                    @csrf
                    @method('delete')
