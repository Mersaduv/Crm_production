    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('sales.cancels.amendments') }}
                    </div>
                            ...
                            <div id="collapse-1" class="collapse" role="tabpanel" aria-labelledby="heading-1"
                                ...
                                <div class="card-body">
                                    <div class="panel-body">
                                        <form method="get" action="{{ route('customers.PrAmends.cancels') }}">
                                            @csrf
                                            <div class="row">
                ...
                <div class="card-header">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link filter-area-pr-cancel-amend active" type="button" role="tab"
                                attr="all">All</button>
                            <button class="nav-link filter-area-pr-cancel-amend" type="button" role="tab"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ route('customers.Pramend.cancel', $customer->id) }}">
