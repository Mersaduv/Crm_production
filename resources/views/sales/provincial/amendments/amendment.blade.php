                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name_persian" class="form-control"
                                        value="{{ $customer->full_name_persian }}" id="full_name_persian"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="poc_persian" class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="amend_date" id="amend_date" class="form-control" value=""
                                        required="required" />
                                </div>
                            </div> <!-- /col -->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="amend_comment" class="form-control" required="required"
