    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Amend Customer</h4>
                
                <div class="history">

                    <div class="row">
                        <div class="col-sm-6">
                           {{ Breadcrumbs::render('sales.pr.amendment',$customer) }}
                        </div>
            ...
            <div class="page-content-box">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('pr.amendmentation',$customer->id) }}">
                            @csrf
                            @method('put')
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <textarea name="amend_comment" 
                                        		  class="form-control"
                                        		  required="required"
                                        		  id="amend_comment" placeholder="Reason"></textarea>
                                    </div>
                                </div> <!-- /col -->
                            </div> <!-- /row -->
