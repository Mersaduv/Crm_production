    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('sales.pr.terminate',$customer) }}
                    </div>
    ...
    <div class="col-sm-12">
        <div class="page-content-box">
            <div class="row">
                ...
                <div class="col-md-3">
                    @include('sales.provincial.terminates.sidebar')
                </div> <!-- /col-3 -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" id="formID"
                    action="{{ route('pr.terminate.edit',$customer->terminate->first()->id) }}">
                    @csrf
                    @method('put')
    ...
    <div class="modal" id="deleteTerminate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" id="formID"
                    action="{{ route('pr.terminate.delete',$customer->terminate->first()->id) }}">
                    @csrf
                    @method('delete')
