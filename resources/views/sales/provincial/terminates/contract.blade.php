    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">Recontract Customer</h4>
                
                <div class="history">

                    <div class="row">
                        <div class="col-sm-6">
                           {{ Breadcrumbs::render('sales.provincial.recontract',$customer) }}
                        </div>
            ...
            <div class="page-content-box">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('pr.contraction',$customer->id) }}">
                            @csrf
                            @method('put')
