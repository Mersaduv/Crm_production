    ...
    <div class="col-sm-12">
        <div class="page-title-box">
            ...
            <div class="history">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {{ Breadcrumbs::render('sales.provincial.add') }}
                    </div>
        ...
        <div class="page-content-box">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('provincial.store') }}">
                        @csrf
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="package_price" id="package_price" class="form-control"
                                        autocomplete="off" placeholder="Package Price:" required="required" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="marketer" id="marketer" autocomplete="off"
                                        class="form-control" placeholder="Field Officer Name:" />
                                    <ul id="marketers_list"></ul>
                                    <input type="hidden" name="marketer_id" id="marketer_id" value="" />
                                </div>
                            </div> <!-- /col -->
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="installation_cost" id="installation_cost"
                                        class="form-control" placeholder="Installation Cost:" />
                                    <div class="input-group-append">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="public_ip" id="public_ip" autocomplete="off"
                                        class="form-control" placeholder="Public IP:" />
                                </div>
                            </div> <!-- /col -->
