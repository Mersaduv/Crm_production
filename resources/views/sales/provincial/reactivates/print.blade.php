	  				...
	  				<div class="row">
	  						...
	  						<table class="table" id="my-table">
								...
								?>
	  							...
	  							<tr>
	  								...
	  								<td>
	  									@if($customer->provincial->PrNocInfo()->exists())
	  										{{ Carbon\Carbon::parse($customer->provincial->PrNocInfo->activation_date)->format('Y-m-d') }}
	  									@else
	  										---
	  									@endif
	  								</td>
								...
								<tr>
	  								<th> تاریخ فعال سازی دوباره </th>
	  								<td>
	  									{{ Carbon\Carbon::parse($customer->reactive_date)->format('Y-m-d') }}
	  								</td>
	  							</tr>
	  							<tr>
	  								<th>بسته اینترنتی</th>
	  							...
	  							<tr class="price">
	  								...
	  								<td>
	  									@if($customer->provincial->Installation_cost)
	  										<span>{{ $customer->provincial->Installation_cost }}</span>
	  										<span>{{ $customer->provincial->Installation_cost_currency }}</span>
	  									@else
	  										---
	  									@endif
	  								</td>
	  					...
	  					<div class="col-sm-6">
	  						<table class="table" id="my-table">
	  							...
	  							<tr>
	  								<th>مسوول فروش</th>
	  								<td> {{ $customer->provincial->user->name }} </td>
	  							</tr>
	  							<tr>
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			...
			try {
			  ...
			  window.location.href = "{{ route('pr.reactivate.details',$customer->id)}}";
			}
		});
	</script>
</body>
