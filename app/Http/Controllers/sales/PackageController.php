...
class PackageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sales.packages.index', compact(['packages', 'categories']));
    }
    ...
    public function create()
    {
        $this->authorize('viewAny', Package::class);
        $categories = Category::all();
        return view('sales.packages.create', compact('categories'));
    }
    ...
    public function show($id)
    {
        ...
        return view('sales.packages.show', compact('package'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('sales.packages.edit', compact(['package', 'categories']));
    }
    ...
    public function restore(Request $request, $id)
    {
        ...
        $package = Package::withTrashed()->find($id)->restore();
        return redirect()->route('packages.index')->with('success', 'Operation Done.');
    }
    ...
    public function trashed()
    {
        ...
        return view('sales.packages.trashed', compact('packages'));
    }
}
