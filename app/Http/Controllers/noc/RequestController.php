...
class RequestController extends Controller
{
    ...
    public function index()
    {
        ...
        $requests = $requests->where('user_id', Auth::user()->id)
            ->paginate(15);
        return view('noc.requests.index', compact('requests'));
    }
    ...
    {
        return view('noc.requests.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('NocRequests.index')->with('success', 'Operation Done.');
    }
    ...
    public function show($id)
    {
        ...
        return view('noc.requests.show', compact('request'));
    }
    ...
    {
        $request = RequestTerminate::find($id);
        return view('noc.requests.edit', compact('request'));
    }
