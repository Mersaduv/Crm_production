...
class ProvincialRequestController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('finance.prRequests.index', compact('requests'));
    }

    // return the create requests form
    public function create()
    {
        return view('finance.prRequests.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('finance.prRequests.show', compact('request'));
    }
    ...
    {
        $request = PrTerminateRequest::find($id);
        return view('finance.prRequests.edit', compact('request'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('trRequests.index')->with('success', 'Operation Done.');
    }
